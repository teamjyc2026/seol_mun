...
/**
 * The five tool declarations, keyed by name so a profile can expose a subset.
 * (Moved verbatim from router.ts — texts unchanged.)
 */
...
export function buildToolDeclarations(names: ToolName[]): FunctionDeclaration[] {
